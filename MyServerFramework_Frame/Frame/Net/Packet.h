...
public:
	...
	uint getSequenceNumber() const					{ return mSequenceNumber; }
	...
	void setSequenceNumber(uint sequence)			{ mSequenceNumber = sequence; }
...
protected:
	...
	uint mSequenceNumber = 0;							// 包的序列号,用于校验是否发送重复相同的包
